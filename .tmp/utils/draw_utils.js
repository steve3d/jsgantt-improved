...
export function newNode(pParent, pNodeType, pId = null, pClass = null, pText = null, pWidth = null, pLeft = null, pDisplay = null, pColspan = null, pAttribs = null) {
    ...
    if (pWidth)
        vNewNode.style.width = (typeof pWidth === 'string') ? pWidth : pWidth + 'px';
    if (pLeft)
        vNewNode.style.left = (typeof pLeft === 'string') ? pLeft : pLeft + 'px';
    if (pText) {
    ...
    if (pColspan && vNewNode instanceof HTMLTableCellElement)
