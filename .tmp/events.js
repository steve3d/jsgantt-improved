import { delayedHide, fadeToolTip, getScrollbarWidth, isParentElementOrSelf, stripIds, updateFlyingObj } from "./utils/general_utils";
...
export function addListenerClickCell(vTmpCell, vEvents, task, column) {
    vTmpCell.addEventListener('click', e => {
        var _a;
        if (((_a = e.target) === null || _a === void 0 ? void 0 : _a.classList.contains('gfoldercollapse')) === false &&
