...
export class TaskItem {
    constructor(vID, vName, pStart, pEnd, vClass, vLink, vMile, pRes, vComp, vGroup, vParent, vOpen, pDepend, vCaption, pNotes, vGantt, vCost, pPlanStart, pPlanEnd, vDuration, vBarText, vDataObject) {
        this.vID = vID;
        this.vName = vName;
        this.vClass = vClass;
        this.vLink = vLink;
