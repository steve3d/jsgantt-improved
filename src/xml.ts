...
export function parseXML(pFile, pGanttVar) {
...
export function parseXMLString(pStr, pGanttVar) {
    let xmlDoc;
...
export function findXMLNode(pRoot, pNodeName) {
    let vRetValue;
...
export function getXMLNodeValue(pRoot, pNodeName, pType, pDefault) {
    let vRetValue;
...
export function AddXMLTask(pGanttVar, pXmlDoc) {
    let project = '';
    let Task;
    let n = 0;
    let m = 0;
